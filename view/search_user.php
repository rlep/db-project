        ...
        <div class="pure-g">
            <div class="pure-u-1-6 pure-menu search-options">
                <ul class="pure-menu-list">
                      <li class="pure-menu-item"><a href="search.php?query=<?php echo htmlentities($query_txt); ?>&post" class="pure-menu-link">Twirps</a></li>
                      <li class="pure-menu-item pure-menu-selected"><a href="search.php?query=<?php echo htmlentities($query_txt); ?>&user" class="pure-menu-link">Users</a></li>
                  </ul>
            </div>
